...
// 	 * @return el numero de mesas disponibles
//	 */
//	public Cola<Mesa> disponibles(Cola<Mesa> colaM){
...
//	}
	...
	/**
 	 ...
 	 * @return el mensaje indicando cual mesa es la mejor
	 */
	public static String mensajeAsignaMejor(Cola<Mesa> colaM, Cola<Cliente> colaC ){
		...
		for (int i=0;i<=colaM.size()-1;i++){
			...
			if((i>0) && (colaM.size() !=2)){//&& (i!=colaM.size()-1)){
				dActual=cupoMesa-numComen;
				if(dMinimo>=dActual){
					//dMinimo = dActual;
					if(dActual>=0){
...
//			}			
	...
	public static void main(String[] args) {
		...
		System.out.println(mensajeAsignaMejor(colaMesas,colaClientes));
