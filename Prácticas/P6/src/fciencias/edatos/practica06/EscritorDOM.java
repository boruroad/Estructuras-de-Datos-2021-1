...
public class EscritorDOM{
     ...
     */
    public void escribe(ArrayList<Ciudad> ciudades )throws// Cola<Automovil> cola) throws 
    ParserConfigurationException, TransformerConfigurationException, TransformerException{
        ...
        // Creación de la raíz.
	    Element raiz = documento.createElement("Ciudades");
	    ...
	    for(int i = 0; i<ciudades.size(); i++){
	    	...
	    	ciudad = documento.createElement("Ciudad");
	    	...
	    	String c =actual.getNombre();
	    	atributo.setValue(c);
	    	ciudad.setAttributeNode(atributo);

	    	Attr atributo2 = documento.createAttribute("estado");
	    	String e = actual.getEstado();
	    	atributo2.setValue(e);
	    	ciudad.setAttributeNode(atributo2);

		    Attr atributo3 = documento.createAttribute("longitud");
		    double l = actual.getLongitud();
		    atributo3.setValue(""+l);
		    ciudad.setAttributeNode(atributo3);

		    Attr atributo4 = documento.createAttribute("latitud");
		    Double lat = actual.getLatitud();
		    atributo4.setValue(""+lat);
		    ciudad.setAttributeNode(atributo4);
	    }
